...
The [balenaEtcher](https://www.balena.io/etcher/) for OS X shoudl work fine. You may have success with the [rpi-imager](https://github.com/raspberrypi/rpi-imager).
