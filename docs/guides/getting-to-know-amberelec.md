...
### Brightness Hotkeys
On devices which have volume buttons (RG351V and RG351MP), brightness can be changed by holding down the `F` (RG351V) or `R3` (RG351MP) buttons along with the volume buttons.
