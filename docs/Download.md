...
</svg> WARNING: You must download the correct version of PineappleELEC for your device</div>

## Version: 20211122 <span style="color: #EEC448;text-shadow: -1px -1px #E944D7;">Pineapple Forest</span>

### Fresh Install

To install PineappleELEC, please follow the instructions on the [Installation page](Installation).
...
To update from a previous version of PineappleELEC, download the update .tar file below for your device and place it in your `GAMES/update` folder. For more detailed instructions, please see the [Upgrade Instructions](Installation#upgrading).
